...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\meshwa\\Documents\\PSYCHO-PY\\Intentional Binding_lastrun.py',
...
polygon_2 = visual.ShapeStim(
    ...
    size=(0.2, 0.2), vertices='circle',
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[-0.4510, 0.0196, 0.4118], fillColor=[-0.4510, 0.0196, 0.4118],
...
trials = data.TrialHandler(nReps=8.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/meshwa/OneDrive/Documents/Tutorial 7 conditions file.xlsx'),
