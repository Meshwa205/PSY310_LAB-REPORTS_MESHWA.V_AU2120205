...
expName = 'Sequence Exp.'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\meshwa\\Documents\\PSYCHO-PY\\Sequence Exp._lastrun.py',
...
trials = data.TrialHandler(nReps=100.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/meshwa/OneDrive/Sequence_con.csv'),
...
# set up handler to look after randomisation of conditions etc
trials_2 = data.TrialHandler(nReps=100.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/meshwa/OneDrive/Sequence_con.csv'),
